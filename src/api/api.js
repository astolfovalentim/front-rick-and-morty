export const Api = {
  baseUrl: "https://mod3-rick-morty.herokuapp.com/",
  keyJwt: localStorage.getItem("keyLogin"),

  // characters
  createCharacterUrl: () => Api.baseUrl + "/characters/create",
  readAllCharactersUrl: (offset) =>
    Api.baseUrl + "/characters?limit=8&offset=" + offset,
  readCharacterByIdUrl: (id) => Api.baseUrl + "/characters/find/" + id,
  readCharacterByNameUrl: (name) =>
    Api.baseUrl + "/characters/search?name=" + name,
